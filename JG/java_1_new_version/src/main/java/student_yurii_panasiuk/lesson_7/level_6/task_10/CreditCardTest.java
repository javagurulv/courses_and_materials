...
@CodeReviewComment(teacher = "Каждый тест кейс должен быть оформлен в отдельном тестовом методе!")
@CodeReviewComment(teacher = "Смотри src/main/java/teacher/lesson_7_encapsulation/codereview/CleanCodeWarning_5.txt")
